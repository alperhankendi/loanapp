...
public class LoanApplicationControllerTest : IClassFixture<TestWebApplicationFactory<Program>>
{
    ...
    public LoanApplicationControllerTest(TestWebApplicationFactory<Program> factory,
