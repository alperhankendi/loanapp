...
namespace Loan.Domain
{
    public class MonetaryAmount : ValueObject<MonetaryAmount> ,IComparable<MonetaryAmount>
    {
        ...
        public MonetaryAmount Add(MonetaryAmount other) => new MonetaryAmount(this.Amount + other.Amount);
        public MonetaryAmount Subtract(MonetaryAmount other) => new MonetaryAmount(this.Amount - other.Amount);
